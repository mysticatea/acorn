(function (global, factory) {
  ...
  pp$1.parseClassElement = function(constructorAllowsSuper) {
    ...
    var tryContextual = function (k, noLineBreak) {
      ...
      if (node.key || !this$1.eatContextual(k)) { return false }
      if (
        (this$1.type === types.name ||
        this$1.type === types.privateId ||
        this$1.type === types.num ||
        this$1.type === types.string ||
        this$1.type === types.bracketL ||
        this$1.type === types.star) &&
    ...
    if (this.options.ecmaVersion < 13 || this.type === types.parenL || kind !== "method" || isGenerator || isAsync) {
